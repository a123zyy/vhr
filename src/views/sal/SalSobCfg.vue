        ...
        methods: {
            ...
            hidePop(data) {
                if (this.currentSalary) {
                    ...
                    client.put('/salary/sobcfg/?eid=' + data.id + '&sid=' + this.currentSalary).then(resp => {
                        if (resp) {
                            this.initEmps()
                        }
                    });
            ...
            initSalaries() {
                client.get("/salary/sobcfg/salaries").then(resp => {
                    if (resp) {
            ...
            initEmps() {
                ...
                client.post("/salary/sobcfg/",paramer).then(resp => {
                    if (resp) {
